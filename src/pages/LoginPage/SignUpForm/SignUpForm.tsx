...
function SignUpForm({ setIsLogin }: Props) {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<formValues>({ resolver: yupResolver(validateSignUpSchema) });

  const handleSignUpByEmail: SubmitHandler<formValues> = (data) => {
    ...
    <div className={cx('container')}>
      ...
      <form className={cx('form')} onSubmit={handleSubmit(handleSignUpByEmail)} id="signup-form">
        ...
        <ButtonBase
          ...
          onClick={handleSubmit(handleSignUpByEmail)}
        >
          Sign Up
        </ButtonBase>
      </form>
